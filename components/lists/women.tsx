...
export default async function WomenList() {
  const products = await getCollectionProducts('hidden-top-pick-for-women');
  return (
    <div className="bg-white my-10">
      <div className="mx-auto max-w-2xl px-4 pt-10 sm:px-6 sm:py-14 lg:max-w-7xl lg:px-8">
        <div className="md:flex md:items-center md:justify-between">
          <h2 className="text-3xl font-bold tracking-tight text-gray-900">Top Pick for women</h2>
          <a
            href="#"
